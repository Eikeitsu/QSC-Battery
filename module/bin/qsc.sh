...
QSC_CLI_CONF_KEYS="power_stop power_start power_stop_time charge_full power_reset Compatibility_mode Shut_down loop_interval_sec loop_interval_maintain_sec switch_verify_sec wireless_policy app_stop app_stop_list history_enable history_interval_sec temperature_switch temperature_switch_stop temperature_switch_start notify_power_status notify_charge_event native_daemon native_impl"
