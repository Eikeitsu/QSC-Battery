...
rm -f "$DATADIR/current_node_blacklist" "$DATADIR/current_node_failcnt" "$DATADIR/current_conf_meta" "$DATADIR/current_conf_snap" "$DATADIR/current_conf_fp" "$DATADIR/current_force_log" 2>/dev/null
