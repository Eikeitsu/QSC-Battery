...
requireText(serviceSource, "qsc_boot_cleanup_logs", "boot log cleanup hook");
requireText(utilSh, "qsc_trim_file_bytes", "byte-capped debug log helper");
requireText(utilSh, "qsc_boot_cleanup_logs", "boot cleanup helper in util");
